...
const Home = () => {
    ...
    // NEW: state for LeetCode-style profile menu
    ...
    return (
        <div className="homePageWrapper">
            ...
            {/* NEW: Updated, full-width sticky header containing logo and profile */}
            <div className="header-nav">
                ...
                {/* LeetCode-Style User Profile Widget on the right */}
                <div className="user-profile-widget">
                    ...
                    >
                        {/* Current letter for now; can be patterned in CSS */}
                    ...
                    {isProfileMenuOpen && (
                        <div className="profile-dropdown-menu">
                            ...
                            <button className="menu-item logout-btn" onClick={handleLogout}>
                                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M10 21H6a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4M16 11l4 4-4 4M20 15H10"/></svg>
                                Logout
                            </button>
                        </div>
                    )}
